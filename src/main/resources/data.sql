INSERT INTO user (user_id, user_name, encoded_password, email, comment, place, birth_day, img_url) VALUES ('kodaira', 'kodaira', '$2a$10$zFEweFHkCxWQSxOXmO.Rn.IlNeXuyHE8DxLLtPKSntbCXF3ZBLG96', 'sample.yahoo.co.jp', 'hoge', 'Tokyo', '2000-01-01', 'example.com');
INSERT INTO user (user_id, user_name, encoded_password, email, comment, place, birth_day, img_url) VALUES ('hoge', 'hoge', '$2a$10$zFEweFHkCxWQSxOXmO.Rn.IlNeXuyHE8DxLLtPKSntbCXF3ZBLG96', 'sample.yahoo.co.jp', 'hoge', 'Tokyo', '2000-01-02', 'example.com');
